    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] gap-4">
        ...
        <p className="text-slate-600 max-w-md text-center">
          Institution management is only available to super admins.
        </p>
      </div>
    );
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">
            Manage tenants (institutions). Add institutions and set tenant isolation level (high or low).
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-sm text-slate-500 mt-1">
            {platformSummary ? `Total: ${platformSummary.count}.` : 'Loading…'}
          </p>
        </div>

        {isLoading || platformSummary === null ? (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 id="add-institution-title" className="text-lg font-semibold text-slate-800">
                Add institution
              </h3>
              <button
                type="button"
